...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    KEYMAP(ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSLS,GRV,   \
           ...
           FN24,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,ENT,             \
           FN29,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,FN28,FN0,             \
                FN31,FN26,          SPC,                FN25,FN30),
...
const action_t fn_actions[] __attribute__ ((section (".keymap.fn_actions"))) = {
    ...
    [22] = ACTION_MODS_ONESHOT(MOD_RGUI),
    [24] = ACTION_MODS_ONESHOT(MOD_LGUI),
    [25] = ACTION_MODS_ONESHOT(MOD_RCTL),
    [26] = ACTION_MODS_ONESHOT(MOD_LCTL),
    [27] = ACTION_MODS_TAP_KEY(MOD_LSFT, KC_ESC),
    [28] = ACTION_MODS_ONESHOT(MOD_RSFT),
    [29] = ACTION_MODS_ONESHOT(MOD_LSFT),
    [30] = ACTION_MODS_ONESHOT(MOD_RALT),
    [31] = ACTION_MODS_ONESHOT(MOD_LALT),
};
#else
